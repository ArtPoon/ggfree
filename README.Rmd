...
I've written a vignette on drawing trees with `ggfree` under the package directory [vignettes/ggfree-trees.html](https://github.com/ArtPoon/ggfree/blob/master/vignettes/ggfree-trees.Rmd).
