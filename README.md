...
the user to add additional information to the plot.
...
make the plot more similar to the `ggtree` example.
...
1.  Rectangular/slanted trees. The above trees have been plotted using a
    rectangular layout.

2.  Circular (radial) trees. This is basically the rectangular layout
    algorithm in a polar coordinate
system.
...
<img src="man/figures/README-unnamed-chunk-16-1.png" width="400" style="display: block; margin: auto;" />
